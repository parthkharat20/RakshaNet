...
export const ROLE_COLORS = {
  VICTIM: '#3B82F6',      // Blue: Defrauded citizen
  MULE_HUB: '#EF4444',    // Red (pulsing): Aggregator / Star Mule Collector
  MULE_NODE: '#F97316',   // Orange: Layering intermediary mule
  CLEAN: '#64748B',       // Slate: Legitimate background account
  ATM: '#10B981'          // Green: Physical cash-out terminal
};
